...
public class Add extends AppCompatActivity implements View.OnClickListener {
    public static final String EXTRA_PROVIDER_NAME = "com.Mypass.password.EXTRA_PROVIDER_NAME";
    public static final String EXTRA_PROVIDER = "com.Mypass.password.EXTRA_PROVIDER";
    public static final String EXTRA_ENCRYPT = "com.Mypass.password.EXTRA_ENCRYPT";
    public static final String EXTRA_EMAIL = "com.Mypass.password.EXTRA_EMAIL";
    public static final String EXTRA_IV = "com.Mypass.password.EXTRA_IV";
    public static final String EXTRA_SALT = "com.Mypass.password.EXTRA_SALT";
    ...
    String[] providersEmail = {
            ...
            "Trello", "Wordpress", "Facebook", "Instagram", "Twitter", "Medium", "Flickr",

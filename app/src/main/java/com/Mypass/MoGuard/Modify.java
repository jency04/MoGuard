...
public class Modify extends AppCompatActivity implements View.OnClickListener {
    ...
    public static final String EXTRA_PROVIDER_NAME = "com.MoGuard.EXTRA_PROVIDER_NAME";
    public static final String EXTRA_ID = "com.MoGuard.EXTRA_ID";
    public static final String EXTRA_ENCRYPT = "com.MoGuard.EXTRA_ENCRYPT";
    public static final String EXTRA_EMAIL = "com.MoGuard.EXTRA_EMAIL";
    public static final String EXTRA_IV = "com.MoGuard.EXTRA_IV";
    public static final String EXTRA_SALT = "com.MoGuard.EXTRA_SALT";

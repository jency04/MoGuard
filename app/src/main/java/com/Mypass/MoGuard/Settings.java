...
import com.Mypass.MoGuard.room.ViyCredDB;
import com.Mypass.MoGuard.ui.password.PasswordViewModel;
...
//                .secretKey("your-secret-key") //optional
        ...
        // Restore
            new Restore.Init()
                    .database(ViyCredDB.getInstance(this))
                    .backupFilePath("storage/emulated/0/MoGuard_BKP.txt")

package com.Mypass.MoGuard.viewadapter;
...
import com.Mypass.MoGuard.Utils.AESUtils;
import com.Mypass.MoGuard.R;
import com.Mypass.MoGuard.models.ViyCred;
...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.viewHolder> {
    ...
    public void onBindViewHolder(viewHolder holder, int position) {
        ...
        switch (creds.getProviderName()) {
            ...
            case "Apple":
                ...
                break;
            case "Facebook":
                holder.providerImage.setImageResource(R.drawable.fb);
                break;
            case "Flickr":
                holder.providerImage.setImageResource(R.drawable.flick);
                break;
            case "Foursquare":
            ...
            case "Github":
                ...
                break;
            case "Gmail":
                holder.providerImage.setImageResource(R.drawable.mail);
                break;
            case "Instagram":
                holder.providerImage.setImageResource(R.drawable.insta);
                break;
            case "Linkedin":
                holder.providerImage.setImageResource(R.drawable.lin);
                break;
            case "Medium":
            ...
            case "Paypal":
                ...
                break;
            case "Pinterest":
                holder.providerImage.setImageResource(R.drawable.pin);
                break;
            case "Reddit":
                holder.providerImage.setImageResource(R.drawable.reddit);
                break;
            case "Skype":
                holder.providerImage.setImageResource(R.drawable.sky);
                break;
            case "Slack":
                holder.providerImage.setImageResource(R.drawable.slack);
                break;
            case "Snapchat":
                holder.providerImage.setImageResource(R.drawable.snap);
                break;
            case "Spotify":
                holder.providerImage.setImageResource(R.drawable.spo);
                break;
            case "Stackoverflow":
            ...
            case "Tumblr":
                ...
                break;
            case "Twitter":
                holder.providerImage.setImageResource(R.drawable.tweet);
                break;
            case "Wordpress":
            ...
            case "Yahoo":
                ...
                break;
            default:
                holder.providerImage.setImageResource(R.drawable.goo);
                break;
        }
        try {
        ...
        holder.cat2.setText(creds.getEmail());
    }
    ...
    class viewHolder extends RecyclerView.ViewHolder {
        ...
        public viewHolder(View view) {
           ...
           cat2 = view.findViewById(R.id.imp_cat);
